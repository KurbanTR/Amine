    ...
    return (
        ...
        {!loading && !getError && (
            ...
            >
                ...
                <button
                    className='self-end z-10 btn-base bg-white text-def-black flex items-center gap-2 text-center cursor-pointer'
            ...
            <div className={s.block_1__titles}>
                ...
                <div className="flex gap-5 items-center mb-12 mt-6">
                    <Rate
                    allowHalf
                    disabled
                    defaultValue={4.5}
                    className='text-4xl text-white 500res:text-3xl'
                    />
            ...
            <article className={s.block_1__details}>
